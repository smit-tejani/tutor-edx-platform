    ...
    function (ValidatingView, CodeMirror, _, $, ui, DateUtils, FileUploadModel,
        ...
        var DetailsView = ValidatingView.extend({
            ...
            render: function () {
                ...
                if (this.model.get('show_consultation_form') == true) {
                    this.$el.find('#' + this.fieldToSelectorMap['consultation_form']).attr('checked', this.model.get('show_consultation_form'));
                }
                else {
                    this.$el.find('#' + this.fieldToSelectorMap['consultation_form']).removeAttr('checked')
                }
            ...
            updateModel: function (event) {
                ...
                switch (event.currentTarget.id) {
                    ...
                    case 'consultation-form':
                        if ($(event.currentTarget).is(':checked')) {
                            this.model.set('show_consultation_form', true);
                        } else {
                            this.model.set('show_consultation_form', false);
                        }
                        break;
